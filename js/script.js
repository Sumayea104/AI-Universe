...
//             <label for="my-modal-3" class="btn btn-circle btn-outline border-hidden text-red-800">
...
//                 <label for="my-modal-3" class="btn btn-sm btn-circle absolute right-2 top-2 bg-white border-hidden text-red-800"> ✕ </label>
...
//   seeMoreBtn.innerHTML = "Loading... <i class='fa fa-spinner fa-spin'></i>";

//   // Set a timeout to remove the spinner after 10 seconds
//   setTimeout(function() {
